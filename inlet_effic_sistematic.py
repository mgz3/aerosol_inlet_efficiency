...
# diametros_iniciales = [4] #diametros iniciales en mm
STOKES_EXT = []
STOKES_INT = []
...
# for diam_1 in diametros_iniciales:
#     STOKES_EXT = []
#     STOKES_INT = []
#
...
#
#         # print('..........................')
#         print('EFICIENCIAS SONDA EXTERNA\n'
#               'Eficiencia Muestreo = {}\n'
...
#
#         # print('..........................')
#         print('EFICIENCIAS SONDA INTERNA\n'
#               'Eficiencia Muestreo = {}\n'
#               'Eficiencia transporte = {}\n'
#               'Eficiencia de la sonda = {}\n'.format(N_SAMPLING_int,N_TRANSPORT_int,N_PROBE_int))
#         print('..........................')
#         print('EFICIENCIAS TOTALES\n'
#               'Eficiencia SONDA EXTERNA = {}\n'
#               'Eficiencia SONDA INTERNA = {}\n'
#               'Eficiencia de la sonda TOTAL = {}\n'.format(N_PROBE_EXT,N_PROBE_int,N_PROBE_EXT*N_PROBE_int))
#         label = str(diam_1) + ' mm V={}m/s'.format(v1)
#     ax.plot(diametros_micro, EFICIENCIAS, label=label)
#     # ax2.plot(diametros_micro, STOKES_EXT, '-',label=label)
#     # ax2.plot(diametros_micro, STOKES_INT,'.',label=label)
#
#
#
...
# ax.legend(title='Initial Diameters')
# ax.grid()
# import os
# path = 'C:\\Users\\mauro\\Desktop\\'
# os.chdir(path)
# fig.savefig('eff_function_diameters_v1_2{}ms.pdf'.format(str(v1)))
# fig.savefig('eff_function_diameters_v1_{}ms.jpg'.format(str(v1)), dpi=300)
# ax.legend(title='Eficiencia de muestreo en funcion de diametro de particula para distintos diametros iniciales')


# plt.legend()
#
# plt.xlabel(r'Diametro $\mu$m', fontsize=4)
# plt.ylabel('Stokes number', fontsize=4)
# plt.title('Numero de stokes en funcion de diametro de particula',fontsize=8)
# ax2.grid()
# ax2.legend()
...
for v1 in VELOCIDADES:
    for diam_1 in diametros_iniciales:
        ...
        diametros_micro = [0.25, 0.35, 0.45, 0.55, 0.65, 0.8, 1, (1.1 + 3) / 2, (3 + 5) / 2, (5 + 7.5) / 2,
                           (7.5 + 10) / 2, (10 + 12.5) / 2, (12.5 + 15) / 2, (15 + 17.5) / 2, (17.5 + 20) / 2,
                           (20 + 22) / 2, (22 + 30) / 2, (30 + 40) / 2, (40 + 50) / 2]
        diametros_micro = np.linspace(0, 50, 1000)
        DIAMETROS = []
        EFICIENCIAS = []
        ...
        for diametro_prueba_part in DIAMETROS:
            ...
            print('EFICIENCIAS TOTALES\n'
                  ...
                  'Eficiencia SONDA INTERNA = {}\n'
                  'Eficiencia de la sonda TOTAL = {}\n'.format(N_PROBE_EXT, N_PROBE_int, N_PROBE_EXT * N_PROBE_int))
            label = str(diam_1) + ' mm V={}ms'.format(str(v1))
...
# path = 'C:\\Users\\mauro\\Desktop\\'
# os.chdir(path)
# fig.savefig('eff_diff_diameters_TWO_VELOC.pdf')
# fig.savefig('eff_diff_diameters_TWO_VELOC.jpg', dpi=3000)